// v1.1 - 토스 빌링키 즉시 결제 프록시 (2026.01.20)
// 기능 요약: FastAPI /api/payments/toss/billing/charge 로 전달 + CORS 허용
...
export async function POST(request) {
  ...
  try {
    ...
    const resp = await fetch(`${API_URL}/api/payments/toss/billing/charge`, {
      method: 'POST',
      headers: {
        ...jsonHeaders(),
        'x-user-id': userId
