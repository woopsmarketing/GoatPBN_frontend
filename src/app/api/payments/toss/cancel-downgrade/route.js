// v1.1 - 토스 다운그레이드 취소 프록시 (2026.01.21)
// 기능 요약: FastAPI /api/payments/toss/cancel-downgrade 로 전달 + CORS 허용
...
export async function POST(request) {
  ...
  try {
    ...
    const resp = await fetch(`${API_URL}/api/payments/toss/cancel-downgrade`, {
      method: 'POST',
      headers: {
        ...jsonHeaders(),
        'x-user-id': userId
