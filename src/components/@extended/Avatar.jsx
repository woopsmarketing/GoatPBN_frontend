...
function getColorStyle({ variant, theme, color, type }) {
...
getColorStyle.propTypes = { variant: PropTypes.any, theme: PropTypes.any, color: PropTypes.any, type: PropTypes.any };
