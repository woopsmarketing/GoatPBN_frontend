          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-red-700 mb-3">
                이 캠페인을 완료하려면 <strong className="text-red-900">{Math.abs(remainingAfter).toLocaleString()}</strong> 크레딧이 더 필요합니다.
                캠페인은 생성되지만, 크레딧이 소진되면 자동으로 중지됩니다.
              </p>
              <button 
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-blue-800">
                <strong>안내:</strong> 콘텐츠가 생성될 때마다 크레딧이 차감됩니다.
                캠페인 도중 중지하면 생성된 콘텐츠만큼만 차감됩니다.
              </p>
            </div>
          </div>
        </div>
